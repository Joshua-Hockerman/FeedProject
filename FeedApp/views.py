...
@login_required
def friends(request):
    # get the admin profile and the user profile to create the first relationship
    ...
    # to get friend requests receiver by the user
    ...
    # check to see WHICH submit button was pressed, either a request or an accept
    ...
    if request.method == "POST" and request.POST.get("receive_requests"):
        ...
        for sender in senders:
            # update the relationship model for the wender to status 'accepted'
